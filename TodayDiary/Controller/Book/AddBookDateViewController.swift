//
//  AddBookDateViewController.swift
//  TodayDiary
//
...
protocol AddBookDateVCDelegate: AnyObject {
    func sendDate(pickerDate: Date)
}

class AddBookDateViewController: UIViewController {

    var picker = UIDatePicker()
    weak var delegate: AddBookDateVCDelegate?
